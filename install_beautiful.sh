...
# 下载美化版PHP文件
echo "正在生成美化版网页..."
curl -s https://raw.githubusercontent.com/yourusername/proxy-manager/main/index.php > /var/www/html/index.php 2>/dev/null || {
    # 如果下载失败，使用内置版本
...
# 追加CSS和HTML部分
cat >> /var/www/html/index.php << 'HTMLEOF'
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
...
.btn-danger{background:linear-gradient(135deg,#f093fb 0%,#f5576c 100%);color:#fff}
...
<div class="header">
<h1>代理中转管理系统</h1>
<div class="subtitle">服务器 IP: <code class="code-highlight"><?php echo $serverIp; ?></code></div>
</div>
<div class="info-card">
